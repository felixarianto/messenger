...
import com.lab.fx.messenger.sms.SmsProcessor;
...
public class MyServices extends IntentService {
            ...
            SMS_CALBACK = new SmsCallback() {
                ...
                public void sendingStatus(String message_id, int p_result) {
                    try {
                        ...
                        message.put(MessageKey.MESSAGE_CODE, MessageCode.SMS_SEND);
                        message.put(MessageKey.MESSAGE_ID,   message_id);
                        message.put(MessageKey.RESULT,       p_result);
                        App.process(message);
                    } catch (Exception e) {
                        Log.e(TAG, "", e);
                    }
                ...
                public void deliveringStatus(String message_id, int p_result) {
                    try {
                        Message message = new Message();
                        message.put(MessageKey.MESSAGE_CODE, MessageCode.SMS_DELIVER);
                        message.put(MessageKey.MESSAGE_ID,   message_id);
                        message.put(MessageKey.RESULT,       p_result);
                        App.process(message);
                    } catch (Exception e) {
    ...
    private void connection() {
        String address = PrefsDB.get(PrefsDB.KEY_APP_ADDRESS, "");
    ...
    private void processor() {
        App.addProcessor(new SmsProcessor());
        App.startProcessor();
    }
