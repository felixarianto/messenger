 ...
 * specified {@link PersonFragment.OnListFragmentInteractionListener}.
...
public class PersonRecyclerViewAdapter extends RecyclerView.Adapter<PersonRecyclerViewAdapter.ViewHolder> {
    ...
    public PersonRecyclerViewAdapter(List<DummyItem> items, PersonFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
